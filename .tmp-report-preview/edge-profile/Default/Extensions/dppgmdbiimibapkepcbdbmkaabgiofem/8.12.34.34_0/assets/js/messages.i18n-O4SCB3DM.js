...
export default {
  de: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " war von einem Sicherheitsvorfall betroffen. " + d.organization + " nutzt 1Password, um sichere Passwörter für alle Ihre Apps zu generieren und automatisch auszufüllen. Schließen Sie die Einrichtung ab, um Ihr Konto zu schützen."; },
    ...
    "Add-username": function(d) { return "Benutzername hinzufügen"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Erstellen Sie mit 1Password ein sichereres Passwort"; },
    ...
    "Set-up-1Password": function(d) { return "1Password einrichten"; },
    ...
    "Username-is-missing": function(d) { return "Benutzername fehlt"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Sie melden sich gerade auf einer kompromittierten Website an"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Ihre Daten waren von einem Sicherheitsvorfall betroffen"; },
    "Your-organization": function(d) { return "Ihre Organisation"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Ihr Passwort für " + d.website + " ist unsicher. " + d.organization + " nutzt 1Password, um sichere Passwörter für alle Ihre Apps zu generieren und automatisch auszufüllen. Schließen Sie die Einrichtung ab, um Ihre Cybersicherheit zu verbessern."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Ihr Passwort für " + d.website + " war von einem Sicherheitsvorfall betroffen. " + d.organization + " nutzt 1Password, um sichere Passwörter für alle Ihre Apps zu generieren und automatisch auszufüllen. Schließen Sie die Einrichtung ab, um dieses Passwort zu ändern."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Ihr Passwort ist in Ihrem Tresor gespeichert, Ihr Benutzername fehlt jedoch."; },
    ...
    "this-website": function(d) { return "diese Website"; },
  ...
  en: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " was found in a security breach. " + d.organization + " uses 1Password to generate and autofill strong passwords for all your apps. Finish set up to protect your account."; },
    ...
    "1Password-will-now-seamlessly-sign-you-in-using-any-login-method-with-a-single-prompt-": function(d) { return "1Password will now seamlessly sign you in using any login method with a single prompt."; },
    ...
    "Add-username": function(d) { return "Add username"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Generate a stronger password with 1Password"; },
    "Got-it": function(d) { return "Got it"; },
    ...
    "Need-access-to-an-AWS-account-not-listed-": function(d) { return "Need access to an AWS account not listed?"; },
    "Never-show-again": function(d) { return "Never show again"; },
    ...
    "Request-access": function(d) { return "Request access"; },
    "Request-access-with-1Password": function(d) { return "Request access with 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Set up 1Password"; },
    ...
    "To-request-access--unlock-your-1Password-privileged-access-account-first-": function(d) { return "To request access, unlock your 1Password privileged access account first."; },
    ...
    "Universal-sign-in-has-arrived": function(d) { return "Universal sign in has arrived"; },
    "Unlock-1Password": function(d) { return "Unlock 1Password"; },
    "Unlock-1Password-to-request-access": function(d) { return "Unlock 1Password to request access"; },
    ...
    "Username-is-missing": function(d) { return "Username is missing"; },
    "View-all": function(d) { return "View all"; },
    "View-settings": function(d) { return "View settings"; },
    "We-d-love-if-you-could-leave-us-a-review-": function(d) { return "We'd love if you could leave us a review!"; },
    ...
    "You-can-adjust-this-any-time-in-settings-": function(d) { return "You can adjust this any time in settings."; },
    "You-can-manage-your-accounts-in-Settings-": function(d) { return "You can manage your accounts in Settings."; },
    "You-re-signing-in-to-a-compromised-website": function(d) { return "You’re signing in to a compromised website"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Your data was found in a security breach"; },
    "Your-organization": function(d) { return "Your organization"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Your password for " + d.website + " is weak. " + d.organization + " uses 1Password to generate and autofill strong passwords for all your apps. Finish set up to improve your cybersecurity."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Your password for " + d.website + " was found in a security breach. " + d.organization + " uses 1Password to generate and autofill strong passwords for all your apps. Finish set up to change this password."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Your password is saved in your vault, but your username is missing."; },
    item: function(d) { return "item"; },
    "one-time-password": function(d) { return "one-time password"; },
    "this-website": function(d) { return "this website"; },
    "autosave-save-type-login": function(d) { return "Login"; },
    "autosave-save-type-credit-card": function(d) { return "Credit card"; },
    "autosave-save-type-identity": function(d) { return "Identity"; },
    "autosave-save-type-api-credential": function(d) { return "API credential"; },
    "autosave-save-type-inline-login": function(d) { return "login"; },
    "autosave-save-type-inline-credit-card": function(d) { return "credit card"; },
    "autosave-save-type-inline-identity": function(d) { return "identity"; },
    "autosave-save-type-inline-api-credential": function(d) { return "API credential"; },
    "autosave-a-item": function(d) { return "a " + d.item; },
    "autosave-an-item": function(d) { return "an " + d.item; }
  },
  es: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return "Se ha detectado " + d.website + " en una violación de seguridad. " + d.organization + " utiliza 1Password para generar y autocompletar contraseñas seguras para todas tus aplicaciones. Finaliza la configuración para proteger tu cuenta."; },
    ...
    "Add-username": function(d) { return "Añadir nombre de usuario"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Generar una contraseña más segura con 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Configurar 1Password"; },
    ...
    "Username-is-missing": function(d) { return "Falta el nombre de usuario"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Estás iniciando sesión en un sitio web comprometido"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Se han encontrado tus datos en una violación de seguridad"; },
    "Your-organization": function(d) { return "Tu organización"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Tu contraseña para " + d.website + " es poco segura. " + d.organization + " utiliza 1Password para generar y autocompletar contraseñas seguras para todas tus aplicaciones. Finaliza la configuración para mejorar su ciberseguridad."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Tu contraseña para " + d.website + " se ha encontrado en una violación de seguridad. " + d.organization + " utiliza 1Password para generar y autocompletar contraseñas seguras para todas tus aplicaciones. Finaliza la configuración para cambiar esta contraseña."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Tu contraseña está guardada en tu bóveda, pero falta tu nombre de usuario."; },
    ...
    "this-website": function(d) { return "este sitio web"; },
  ...
  fr: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " a été identifié comme ayant fait l'objet d'une faille de sécurité. " + d.organization + " utilise 1Password pour générer et remplir automatiquement des mots de passe forts pour toutes vos applications. Terminez la configuration pour protéger votre compte."; },
    ...
    "Add-username": function(d) { return "Ajouter un nom d'utilisateur"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Générer un mot de passe plus sûr avec 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Configurer 1Password"; },
    ...
    "Username-is-missing": function(d) { return "Nom d'utilisateur manquant"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Vous vous connectez à un site web compromis"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Vos données ont été compromises lors d'une faille de sécurité"; },
    "Your-organization": function(d) { return "Votre organisation"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Votre mot de passe pour " + d.website + " n'est pas suffisamment sécurisé. " + d.organization + " utilise 1Password pour générer et remplir automatiquement des mots de passe sécurisés pour toutes vos applications. Terminez la configuration afin d'améliorer votre cybersécurité."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Votre mot de passe pour " + d.website + " a été identifié comme ayant fait l'objet d'une faille de sécurité. " + d.organization + " utilise 1Password pour générer et remplir automatiquement des mots de passe forts pour toutes vos applications. Terminez la configuration pour modifier ce mot de passe."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Votre mot de passe est enregistré dans votre coffre, mais votre nom d'utilisateur n'y figure pas."; },
    ...
    "this-website": function(d) { return "ce site web"; },
  ...
  it: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " è stato rilevato in una violazione dei dati. " + d.organization + " usa 1Password per generare e compilare automaticamente password complesse per tutte le tue app. Completa la configurazione per proteggere il tuo account."; },
    ...
    "Add-username": function(d) { return "Aggiungi nome utente"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Genera una password più sicura con 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Configura 1Password"; },
    ...
    "Username-is-missing": function(d) { return "Nome utente mancante"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Stai accedendo a un sito web compromesso"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "I tuoi dati sono stati rilevati in una violazione dei dati"; },
    "Your-organization": function(d) { return "La tua organizzazione"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "La tua password per " + d.website + " è debole. " + d.organization + " usa 1Password per generare e compilare automaticamente password complesse per tutte le tue app. Completa la configurazione per migliorare la tua sicurezza online."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "La tua password per " + d.website + " è stata rilevata in una violazione dei dati. " + d.organization + " usa 1Password per generare e compilare automaticamente password complesse per tutte le tue app. Completa la configurazione per modificare questa password."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "La password è salvata nella tua cassaforte, ma manca il nome utente."; },
    "a--item-": function(d) { return "un " + d.item; },
    "an--item-": function(d) { return "un " + d.item; },
    "an-Item": function(d) { return "un elemento"; },
    "one-time-password": function(d) { return "password monouso"; },
    "system-authentication": function(d) { return "autenticazione di sistema"; },
    "this-website": function(d) { return "questo sito"; },
  ...
  ja: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + "でセキュリティ侵害が確認されました。" + d.organization + "では、1Passwordを使用して、すべてのアプリで強固なパスワードを生成し、自動入力しています。アカウントを保護するために、設定を完了してください。"; },
    ...
    "Add-username": function(d) { return "ユーザー名を追加する"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "1Passwordでより強力なパスワードを生成する"; },
    ...
    "Set-up-1Password": function(d) { return "1Passwordを設定する"; },
    ...
    "Username-is-missing": function(d) { return "ユーザー名が入力されていません"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "侵害されたウェブサイトにサインインしています"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "セキュリティ違反であなたのデータが見つかりました"; },
    "Your-organization": function(d) { return "あなたの組織"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return d.website + "のパスワードは脆弱です。" + d.organization + "では、1Password を使用して、すべてのアプリで強固なパスワードを生成し、自動入力しています。設定を完了して、サイバーセキュリティを強化しましょう。"; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return d.website + " のパスワードが、セキュリティ侵害により流出していることが判明しました。" + d.organization + "では、1Passwordを使用して、すべてのアプリで強固なパスワードを生成し、自動入力しています。設定を完了して、アカウントを保護しましょう。"; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "パスワードは保管庫に保存されていますが、ユーザー名が見つかりません。"; },
    ...
    "this-website": function(d) { return "このウェブサイト"; },
  ...
  ko: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return "보안 침해 사고에서 " + d.website + "이(가) 발견되었습니다. " + d.organization + "에서는 1Password를 사용하여 모든 앱에 대해 강력한 비밀번호를 생성하고 자동으로 입력합니다. 설정을 완료하여 계정을 보호하세요."; },
    ...
    "Add-username": function(d) { return "사용자 이름 추가"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "1Password를 사용하여 더 강력한 비밀번호를 생성하세요"; },
    ...
    "Set-up-1Password": function(d) { return "1Password 설정"; },
    ...
    "Username-is-missing": function(d) { return "사용자 이름이 누락되었습니다"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "현재 보안이 침해된 웹사이트에 로그인하고 있습니다"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "보안 침해 사고에서 회원님의 데이터가 발견되었습니다"; },
    "Your-organization": function(d) { return "회원님의 조직"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "회원님의 " + d.website + " 비밀번호는 취약합니다. 1Password는 모든 앱에 대해 강력한 비밀번호를 생성하고 자동으로 입력합니다. 설정을 완료하여 사이버 보안을 향상시키세요."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "보안 침해 사고에서 회원님의 " + d.website + " 비밀번호가 발견되었습니다. " + d.organization + "에서는 1Password를 사용하여 모든 앱에 대해 강력한 비밀번호를 생성하고 자동으로 입력합니다. 설정을 완료하여 이 비밀번호를 변경하세요."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "회원님의 비밀번호는 금고에 저장되어 있지만 사용자 이름이 누락되어 있습니다."; },
    ...
    "this-website": function(d) { return "이 웹사이트"; },
  ...
  nl: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " is gevonden in een datalek. " + d.organization + " gebruikt 1Password om sterke wachtwoorden te genereren en automatisch in te vullen voor al je apps. Voltooi de configuratie om je account te beschermen."; },
    ...
    "Add-username": function(d) { return "Gebruikersnaam toevoegen"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Genereer een sterker wachtwoord met 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "1Password instellen"; },
    ...
    "Username-is-missing": function(d) { return "Gebruikersnaam ontbreekt"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Je logt in op een gecompromitteerde website"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Je gegevens zijn gevonden in een datalek"; },
    "Your-organization": function(d) { return "Je organisatie"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Je wachtwoord voor " + d.website + " is zwak. " + d.organization + " gebruikt 1Password om sterke wachtwoorden te genereren en automatisch in te vullen voor al je apps. Voltooi de configuratie om je cybersecurity te verbeteren."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Je wachtwoord voor " + d.website + " is gevonden in een datalek. " + d.organization + " gebruikt 1Password om sterke wachtwoorden te genereren en automatisch in te vullen voor al je apps. Voltooi de configuratie om dit wachtwoord te wijzigen."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Je wachtwoord is opgeslagen in je kluis, maar je gebruikersnaam ontbreekt."; },
    ...
    "this-website": function(d) { return "deze website"; },
  ...
  pt: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return "O " + d.website + " foi encontrado em uma violação de segurança. A " + d.organization + " usa o 1Password para gerar e preencher automaticamente senhas fortes para todos os seus aplicativos. Conclua a configuração para proteger sua conta."; },
    ...
    "Add-username": function(d) { return "Adicionar nome de usuário"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Crie uma senha mais forte com o 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Configure o 1Password"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Você está acessando um site comprometido"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Seus dados foram encontrados em uma violação de segurança"; },
    "Your-organization": function(d) { return "Sua organização"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Sua senha para " + d.website + " é fraca. A " + d.organization + " usa o 1Password para gerar e preencher automaticamente senhas fortes para todos os seus aplicativos. Conclua a configuração para melhorar sua segurança cibernética."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Sua senha para " + d.website + " foi encontrada em uma violação de segurança. A " + d.organization + " usa o 1Password para gerar e preencher automaticamente senhas fortes para todos os seus aplicativos. Conclua a configuração para alterar essa senha."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Sua senha está salva no seu cofre, mas seu nome de usuário está faltando."; },
    ...
    "this-website": function(d) { return "este site"; },
    "autosave-save-type-login": function(d) { return "Login"; },
  ...
  ru: {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return "Ваш пароль для " + d.website + " был обнаружен в результатах утечки данных. " + d.organization + " использует 1Password для создания и автозаполнения надежных паролей для всех ваших приложений. Завершите настройку, чтобы защитить свой аккаунт."; },
    ...
    "Add-username": function(d) { return "Добавить имя пользователя"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "Создать более сильный пароль с 1Password"; },
    ...
    "Set-up-1Password": function(d) { return "Настроить 1Password"; },
    ...
    "Username-is-missing": function(d) { return "Отсутствует имя пользователя"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "Вы входите на взломанный сайт"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "Ваши данные были обнаружены в результате утечки данных"; },
    "Your-organization": function(d) { return "Ваша организация"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "Ваш пароль для " + d.website + " слишком слабый. " + d.organization + " использует 1Password для создания и автоматического заполнения надежных паролей для всех ваших приложений. Завершите настройку, чтобы повысить уровень своей безопасности онлайн."; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "Ваш пароль для " + d.website + " был обнаружен в результатах утечки данных. " + d.organization + " использует 1Password для создания и автозаполнения надежных паролей для всех ваших приложений. Завершите настройку, чтобы повысить уровень своей безопасности онлайн."; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "Ваш пароль сохранен в сейфе, но ваше имя пользователя отсутствует."; },
    "a--item-": function(d) { return d.item; },
    "an--item-": function(d) { return d.item; },
    ...
    "this-website": function(d) { return "этот веб-сайт"; },
  ...
  "zh-CN": {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " 曾发生安全数据泄露。" + d.organization + " 使用 1Password 为你的所有应用生成并自动填入高强度密码。完成设置，以保护你的帐户。"; },
    ...
    "Add-username": function(d) { return "添加用户名"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "使用 1Password 生成更强大的密码"; },
    ...
    "Set-up-1Password": function(d) { return "设置 1Password"; },
    ...
    "Username-is-missing": function(d) { return "用户名缺失"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "您正在登录曾泄露信息的网站"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "您的数据出现在安全数据泄露事件中"; },
    "Your-organization": function(d) { return "您的组织"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "你在 " + d.website + " 的密码强度较弱。" + d.organization + " 使用 1Password 为你的所有应用生成并自动填入高强度密码。完成设置，提升你的网络安全防护。"; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "你在 " + d.website + " 的密码曾出现在安全数据泄露事件中。" + d.organization + " 使用 1Password 为你的所有应用生成并自动填入高强度密码。完成设置，更改此密码。"; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "您的密码已保存在保险库中，但您的用户名缺失。"; },
    ...
    "this-website": function(d) { return "此网站"; },
  ...
  "zh-TW": {
    ...
    "-website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-protect-your-account-": function(d) { return d.website + " 曾發生安全資料外洩。 " + d.organization + " 使用 1Password 為你的所有應用程式產生並自動填入高強度密碼。完成設置，以保護你的帳號。"; },
    ...
    "Add-username": function(d) { return "新增使用者名稱"; },
    "All-good": function(d) { return "一切正常"; },
    ...
    "Generate-a-stronger-password-with-1Password": function(d) { return "使用 1Password 產生更強大的密碼"; },
    ...
    "Set-up-1Password": function(d) { return "設定 1Password"; },
    ...
    "Username-is-missing": function(d) { return "使用者名稱缺失"; },
    ...
    "You-re-signing-in-to-a-compromised-website": function(d) { return "您正在登入曾洩漏資訊的網站"; },
    ...
    "Your-data-was-found-in-a-security-breach": function(d) { return "您的資料出現在安全資料外洩事件中"; },
    "Your-organization": function(d) { return "您的組織"; },
    "Your-password-for--website--is-weak---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-improve-your-cybersecurity-": function(d) { return "你在 " + d.website + " 的密碼強度較弱。 " + d.organization + " 使用 1Password 為你的所有應用程式產生並自動填入高強度密碼。完成設置，提升你的網路安全防護。"; },
    "Your-password-for--website--was-found-in-a-security-breach---organization--uses-1Password-to-generate-and-autofill-strong-passwords-for-all-your-apps--Finish-set-up-to-change-this-password-": function(d) { return "你在 " + d.website + " 的密碼曾出現在安全資料外洩事件中。 " + d.organization + " 使用 1Password 為你的所有應用程式產生並自動填入高強度密碼。完成設定，變更此密碼。"; },
    "Your-password-is-saved-in-your-vault--but-your-username-is-missing-": function(d) { return "您的密碼已儲存在保險庫中，但使用者名缺失。"; },
    ...
    "this-website": function(d) { return "此網站"; },
