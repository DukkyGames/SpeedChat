...
export default {
  de: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " erfordert nun, dass Sie sich mit " + d.identityProvider + " bei 1Password anmelden"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " erfordert nun, dass Sie sich mit " + d.ssoProvider + " bei 1Password anmelden."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return "Bei " + d.accountName + " müssen Sie sich nun über " + d.identityProvider + " anmelden. Melden Sie sich bei " + d.ssoAccountName + " ab und versuchen Sie es erneut."; },
    ...
    Ok: function(d) { return "OK"; },
    "Open-1password-com": function(d) { return "Öffnen Sie 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Melden Sie sich auf 1Password.com an, um Ihre Daten in Ihr Familienkonto zu übertragen. Weitere Informationen finden Sie in Ihrer E-Mail. Bitte erledigen Sie dies bald, da Ihr Konto und Ihre Daten andernfalls endgültig gelöscht werden."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Melden Sie sich in Ihrem Browser bei " + d.accountName + " an."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Melden Sie sich in Ihrem Browser bei " + d.identityProvider + " an"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Mit " + d.displayName + " anmelden"; },
    ...
    "Unknown-Card": function(d) { return "Unbekannte Karte"; },
    ...
    "Virtual-Card": function(d) { return "Virtuelle Karte"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Sie wurden aus Ihrem Familienkonto entfernt"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Sie müssen Ihren Browser öffnen, um die Anmeldung abzuschließen."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Ihr Konto nutzt nun die Anmeldung über " + d.identityProvider + ". Bitte öffnen Sie Ihren Browser, um die Anmeldung abzuschließen."; },
    ...
    "Your-administrator": function(d) { return "Ihr Administrator"; },
    "one-time-password": function(d) { return "einmaliges Passwort"; },
    "use-a-passkey": function(d) { return "Einen Passkey verwenden"; },
    "your-browser": function(d) { return "Ihren Browser"; },
    "your-identity-provider": function(d) { return "Ihrem Identitätsanbieter"; },
  ...
  en: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " now requires you to sign in to 1Password with " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " now requires you to sign in to 1Password with " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " now requires you to use " + d.identityProvider + " to sign in. Sign out of " + d.ssoAccountName + ", then try again."; },
    ...
    "API-Credential": function(d) { return "API Credential"; },
    ...
    OK: function(d) { return "OK"; },
    Ok: function(d) { return "Ok"; },
    "Open-1password-com": function(d) { return "Open 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Sign in on 1Password.com to move your data into your own family account. Check your email for more information. If you don't complete this soon, your account and data will be permanently deleted."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Sign in to " + d.accountName + " in your browser."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Sign in to " + d.identityProvider + " in your browser"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Sign in with " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Unknown Card"; },
    ...
    "Virtual-Card": function(d) { return "Virtual Card"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "You have been removed from your family account"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "You'll need to open your browser to complete sign-in."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Your account has switched to signing in with " + d.identityProvider + ". You'll need to open your browser to complete sign-in."; },
    ...
    "Your-administrator": function(d) { return "Your administrator"; },
    "one-time-password": function(d) { return "one-time password"; },
    "use-a-passkey": function(d) { return "use a passkey"; },
    "your-browser": function(d) { return "your browser"; },
    "your-identity-provider": function(d) { return "your identity provider"; }
  },
  es: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " ahora requiere que inicies sesión en 1Password con " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " ahora requiere que inicies sesión en 1Password con " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " requiere en estos momentos que uses " + d.identityProvider + " para iniciar sesión. Cierra la sesión de " + d.ssoAccountName + " y vuelve a intentarlo."; },
    ...
    Ok: function(d) { return "Ok"; },
    "Open-1password-com": function(d) { return "Abrir 1password.com"; },
    Personal: function(d) { return "Personal"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Inicia sesión en 1Password.com para mover tus datos a tu propia cuenta familiar. Revisa tu correo electrónico para más información. Si no completas este paso pronto, tu cuenta y tus datos se eliminarán permanentemente."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Inicia sesión en " + d.accountName + " en tu navegador."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Inicia sesión en " + d.identityProvider + " en tu navegador"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Iniciar sesión con " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Tarjeta desconocida"; },
    ...
    "Virtual-Card": function(d) { return "Tarjeta virtual"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Se te ha eliminado de la cuenta familiar"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Necesitarás abrir tu navegador para iniciar sesión."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Tu cuenta ha cambiado para iniciar sesión con " + d.identityProvider + ". Tendrás que abrir tu navegador para completar el inicio de sesión."; },
    ...
    "Your-administrator": function(d) { return "Tu administrador"; },
    "one-time-password": function(d) { return "contraseña de un solo uso"; },
    "use-a-passkey": function(d) { return "usar una clave"; },
    "your-browser": function(d) { return "tu navegador"; },
    "your-identity-provider": function(d) { return "tu proveedor de identidad"; },
    "unit.B": function(d) { return d.size + " bytes"; },
    "unit.KB": function(d) { return d.size + " KB"; },
    "unit.MB": function(d) { return d.size + " MB"; },
    "unit.GB": function(d) { return d.size + " GB"; },
  ...
  fr: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " vous demande désormais de vous connecter à 1Password via " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " vous demande désormais de vous connecter à 1Password via " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " vous demande désormais d'utiliser " + d.identityProvider + " pour vous connecter. Déconnectez-vous de " + d.ssoAccountName + ", puis réessayez."; },
    ...
    OK: function(d) { return "OK"; },
    Ok: function(d) { return "OK"; },
    "Open-1password-com": function(d) { return "Ouvrir 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Connectez-vous sur 1Password.com pour transférer vos données vers votre compte famille. Consultez vos e-mails pour plus d'informations. Si vous ne procédez pas rapidement à cette opération, votre compte et vos données seront définitivement supprimés."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Connectez-vous à " + d.accountName + " dans votre navigateur."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Connectez-vous à " + d.identityProvider + " dans votre navigateur"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Connectez-vous avec " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Carte inconnue"; },
    ...
    "Virtual-Card": function(d) { return "Carte virtuelle"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Vous ne faites plus partie de votre compte familial"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Vous devrez ouvrir votre navigateur pour terminer la connexion."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Votre compte utilise désormais " + d.identityProvider + " pour la connexion. Vous devrez ouvrir votre navigateur pour terminer la connexion."; },
    ...
    "Your-administrator": function(d) { return "Votre administrateur"; },
    "one-time-password": function(d) { return "mot de passe à usage unique"; },
    "use-a-passkey": function(d) { return "utiliser une clé d'accès"; },
    "your-browser": function(d) { return "votre navigateur"; },
    "your-identity-provider": function(d) { return "votre fournisseur d'identité"; },
  ...
  it: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " ora richiede di accedere a 1Password con " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " ora richiede di accedere a 1Password con " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " ora ti richiede di usare " + d.identityProvider + " per effettuare l’accesso. Esci da " + d.ssoAccountName + ", quindi riprova."; },
    ...
    OK: function(d) { return "OK"; },
    Ok: function(d) { return "Ok"; },
    "Open-1password-com": function(d) { return "Apri 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Accedi a 1Password.com per spostare i tuoi dati nel tuo account di famiglia. Controlla la tua email per ulteriori informazioni. Se non completi questa procedura a breve, il tuo account e i tuoi dati verranno eliminati definitivamente."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Accedi a " + d.accountName + " nel tuo browser."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Accedi a " + d.identityProvider + " nel tuo browser"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Accedi con " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Carta sconosciuta"; },
    ...
    "Virtual-Card": function(d) { return "Carta virtuale"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Sei stato rimosso dal tuo account familiare"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Dovrai aprire il tuo browser per completare l’accesso."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Il tuo account ora usa " + d.identityProvider + " per l’accesso. Dovrai aprire il browser per completare l’accesso."; },
    ...
    "Your-administrator": function(d) { return "Il tuo amministratore"; },
    "one-time-password": function(d) { return "password monouso"; },
    "use-a-passkey": function(d) { return "usa una chiave di accesso"; },
    "your-browser": function(d) { return "il tuo browser"; },
    "your-identity-provider": function(d) { return "il tuo provider di identità"; },
  ...
  ja: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + "では、" + d.identityProvider + "を使用して1Password にサインインする必要があります"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + "では、" + d.ssoProvider + "を使用して1Password にサインインする必要があります."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + "には、 " + d.identityProvider + "を使用してサインインする必要があります。 " + d.ssoAccountName + "からサインアウトしてから、もう一度お試しください。"; },
    ...
    OK: function(d) { return "OK"; },
    Ok: function(d) { return "OK"; },
    "Open-1password-com": function(d) { return "1password.comを開く"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "1Password.com にサインインして、データを自身の家族アカウントに移行してください。詳細についてはメールをご確認ください。早急にこの手続きを完了しない場合、アカウントとデータは完全に削除されます。"; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "ブラウザで" + d.accountName + "にサインインする。"; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "ブラウザで" + d.identityProvider + "にサインインする"; },
    ...
    "Sign-in-with--displayName-": function(d) { return d.displayName + "でサインイン"; },
    ...
    "Unknown-Card": function(d) { return "不明なカード"; },
    ...
    "Virtual-Card": function(d) { return "バーチャルカード"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "家族アカウントから削除されました"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "サインインを完了するには、ブラウザを開く必要があります。"; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "アカウントは " + d.identityProvider + "でのサインインに切り替わりました。サインインを完了するにはブラウザを開く必要があります。"; },
    ...
    "Your-administrator": function(d) { return "管理者"; },
    "one-time-password": function(d) { return "ワンタイムパスワード"; },
    "use-a-passkey": function(d) { return "パスキーを使用する"; },
    "your-browser": function(d) { return "お使いのブラウザ"; },
    "your-identity-provider": function(d) { return "あなたのIDプロバイダ"; },
  ...
  ko: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + "의 정책에 따라 이제 " + d.identityProvider + "을(를) 통해 1Password에 로그인해야 합니다"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + "의 정책에 따라 이제 " + d.ssoProvider + "을(를) 통해 1Password에 로그인해야 합니다."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + "의 정책에 따라 이제 " + d.identityProvider + "을(를) 사용하여 로그인해야 합니다. " + d.ssoAccountName + "에서 로그아웃한 다음, 다시 시도하세요."; },
    ...
    Ok: function(d) { return "확인"; },
    "Open-1password-com": function(d) { return "1password.com 열기"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "1Password.com에 로그인하여 회원님의 데이터를 가족 계정으로 이전하세요. 자세한 정보는 이메일을 참조하시기 바랍니다. 이 작업을 신속히 완료하지 않으시면 회원님의 계정과 데이터가 영구적으로 삭제됩니다."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "사용 중인 브라우저에서 " + d.accountName + "에 로그인하세요."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "사용 중인 브라우저에서 " + d.identityProvider + "에 로그인하세요"; },
    ...
    "Sign-in-with--displayName-": function(d) { return d.displayName + "(으)로 로그인"; },
    ...
    "Unknown-Card": function(d) { return "알 수 없는 카드"; },
    ...
    "Virtual-Card": function(d) { return "가상 카드"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "회원님은 가족 계정에서 제거되었습니다"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "브라우저를 열고 로그인을 완료해야 합니다."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "회원님의 계정은 " + d.identityProvider + "을(를) 사용하여 로그인하도록 전환되었습니다. 브라우저를 열고 로그인을 완료해야 합니다."; },
    ...
    "Your-administrator": function(d) { return "회원님의 관리자"; },
    "one-time-password": function(d) { return "일회용 비밀번호"; },
    "use-a-passkey": function(d) { return "패스키 사용"; },
    "your-browser": function(d) { return "사용 중인 브라우저"; },
    "your-identity-provider": function(d) { return "회원님의 ID 공급자"; },
  ...
  nl: {
    ...
    "-accountName--is-offline-": function(d) { return d.accountName + " is offline."; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " vereist nu dat je met " + d.identityProvider + " inlogt bij 1Password"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " vereist nu dat je met " + d.ssoProvider + " inlogt bij 1Password."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " vereist nu dat je met " + d.identityProvider + " inlogt. Log uit bij " + d.ssoAccountName + " en probeer het opnieuw."; },
    ...
    OK: function(d) { return "OK"; },
    Ok: function(d) { return "Ok"; },
    "Open-1password-com": function(d) { return "1Password.com openen"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Log in op 1Password.com om je gegevens naar je eigen gezinsaccount te verplaatsen. Controleer je e-mail voor meer informatie. Als je deze actie niet snel uitvoert, worden je account en gegevens permanent verwijderd."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Log in op " + d.accountName + " in je browser."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Log in op " + d.identityProvider + " in je browser"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Log in met " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Onbekende kaart"; },
    ...
    "Virtual-Card": function(d) { return "Virtuele kaart"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Je bent uit je gezinsaccount verwijderd"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Je moet je browser openen om het inloggen te voltooien."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Je account is omgezet naar inloggen met " + d.identityProvider + ". Open je browser om het inloggen te voltooien."; },
    ...
    "Your-administrator": function(d) { return "Je beheerder"; },
    "one-time-password": function(d) { return "eenmalig wachtwoord"; },
    "use-a-passkey": function(d) { return "een passkey gebruiken"; },
    "your-browser": function(d) { return "jouw browser"; },
    "your-identity-provider": function(d) { return "je identiteitsprovider"; },
    "unit.B": function(d) { return d.size + " bytes"; },
    "unit.KB": function(d) { return d.size + " KB"; },
    "unit.MB": function(d) { return d.size + " MB"; },
    "unit.GB": function(d) { return d.size + " GB"; },
  ...
  pt: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " agora exige que você faça login no 1Password com " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " agora exige que você faça login no 1Password com " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " agora exige que você use " + d.identityProvider + " para entrar. Saia de " + d.ssoAccountName + " e tente novamente."; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Faça login em 1Password.com para mover seus dados para sua própria conta familiar. Verifique seu e-mail para mais informações. Se você não concluir isso em breve, sua conta e seus dados serão excluídos permanentemente."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Faça login em " + d.accountName + " no seu navegador."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Faça login em " + d.identityProvider + " no seu navegador"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Fazer login com " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Cartão sem identificação"; },
    ...
    "Virtual-Card": function(d) { return "Cartão eletrônico"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Você foi removido da sua conta familiar"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Você precisará abrir seu navegador para concluir o login."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Sua conta passou a usar o " + d.identityProvider + " para login. Você precisará abrir o navegador para concluir a autenticação."; },
    ...
    "Your-administrator": function(d) { return "Seu administrador"; },
    "one-time-password": function(d) { return "senha de uso único"; },
    "use-a-passkey": function(d) { return "use uma chave de acesso"; },
    "your-browser": function(d) { return "seu navegador"; },
    "your-identity-provider": function(d) { return "seu provedor de identidade"; },
    "unit.B": function(d) { return d.size + " bytes"; },
    "unit.KB": function(d) { return d.size + " KB"; },
    "unit.MB": function(d) { return d.size + " MB"; },
    "unit.GB": function(d) { return d.size + " GB"; },
  ...
  ru: {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return "Теперь для " + d.accountName + " требуется войти в аккаунт 1Password с помощью " + d.identityProvider; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return "Теперь для " + d.accountName + " требуется войти в аккаунт 1Password с помощью " + d.ssoProvider + "."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return "Для входа в аккаунт " + d.accountName + " требуется использовать " + d.identityProvider + ". Выйдите из аккаунта " + d.ssoAccountName + ", а затем попробуйте еще раз."; },
    ...
    "Open-1password-com": function(d) { return "Открыть 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "Войдите на 1Password.com, чтобы перенести свои данные в свой семейный аккаунт. Проверьте свою эл. почту для получения дополнительной информации. Если вы не завершите этот процесс в ближайшее время, ваш аккаунт и данные будут удалены навсегда."; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "Войдите в аккаунт " + d.accountName + " в своем браузере."; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "Войдите в аккаунт " + d.identityProvider + " в своем браузере"; },
    ...
    "Sign-in-with--displayName-": function(d) { return "Войти в аккаунт с " + d.displayName; },
    ...
    "Unknown-Card": function(d) { return "Неизвестная карта"; },
    ...
    "Virtual-Card": function(d) { return "Виртуальная карта"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "Вы были удалены из семейного аккаунта"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Для завершения входа в аккаунт вам необходимо открыть браузер."; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "Для входа в ваш аккаунт теперь используется " + d.identityProvider + ". Чтобы завершить вход в аккаунт, откройте браузер."; },
    ...
    "Your-administrator": function(d) { return "Ваш администратор"; },
    "one-time-password": function(d) { return "одноразовый пароль"; },
    "use-a-passkey": function(d) { return "использовать passkey"; },
    "your-browser": function(d) { return "ваш браузер"; },
    "your-identity-provider": function(d) { return "ваш поставщик идентификационной информации"; },
  ...
  "zh-CN": {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " 现在要求你通过 " + d.identityProvider + " 登录 1Password"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " 现在要求你通过 " + d.ssoProvider + " 登录 1Password."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " 现要求你使用 " + d.identityProvider + " 登录。请先退出 " + d.ssoAccountName + "，然后再试一次。"; },
    ...
    Ok: function(d) { return "好"; },
    "Open-1password-com": function(d) { return "打开 1password.com"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "请登录 1Password.com 将您的数据迁移到您自己的家庭帐户。请查看您的电子邮件以获取更多信息。如果不尽快完成此操作，您的帐户和数据将被永久删除。"; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "在你的浏览器中登录 " + d.accountName + "。"; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "在你的浏览器中登录 " + d.identityProvider; },
    ...
    "Sign-in-with--displayName-": function(d) { return "通过 " + d.displayName + " 登录"; },
    ...
    "Unknown-Card": function(d) { return "未知卡片"; },
    ...
    "Virtual-Card": function(d) { return "虚拟卡片"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "您已从家庭帐户中被移除"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "您需要打开您的浏览器来完成登录。"; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "你的帐户已切换为使用 " + d.identityProvider + " 登录。你需要开启浏览器以完成登录。"; },
    ...
    "Your-administrator": function(d) { return "您的管理员"; },
    "one-time-password": function(d) { return "一次性密码"; },
    "use-a-passkey": function(d) { return "使用通行密钥"; },
    "your-browser": function(d) { return "你的浏览器"; },
    "your-identity-provider": function(d) { return "您的身份标识供应商"; },
  ...
  "zh-TW": {
    ...
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--identityProvider-": function(d) { return d.accountName + " 現在要求你透過 " + d.identityProvider + " 登入 1Password"; },
    "-accountName--now-requires-you-to-sign-in-to-1Password-with--ssoProvider--": function(d) { return d.accountName + " 現在要求你透過 " + d.ssoProvider + " 登入 1Password."; },
    "-accountName--now-requires-you-to-use--identityProvider--to-sign-in--Sign-out-of--ssoAccountName---then-try-again-": function(d) { return d.accountName + " 現在要求你使用 " + d.identityProvider + " 登入。請先退出 " + d.ssoAccountName + "，然後再試一次。"; },
    ...
    OK: function(d) { return "好"; },
    Ok: function(d) { return "好"; },
    "Open-1password-com": function(d) { return "開啟 1password.com"; },
    Personal: function(d) { return "個人"; },
    ...
    "Sign-in-on-1Password-com-to-move-your-data-into-your-own-family-account--Check-your-email-for-more-information--If-you-don-t-complete-this-soon--your-account-and-data-will-be-permanently-deleted-": function(d) { return "請登入 1Password.com 將您的資料移轉到您自己的家庭帳號。請查看您的電子郵件以取得更多資訊。如果不盡快完成此動作，您的帳號和資料將永久刪除。"; },
    "Sign-in-to--accountName--in-your-browser-": function(d) { return "在你的瀏覽器中登入 " + d.accountName + "。"; },
    "Sign-in-to--identityProvider--in-your-browser": function(d) { return "在你的瀏覽器中登入 " + d.identityProvider; },
    ...
    "Sign-in-with--displayName-": function(d) { return "透過 " + d.displayName + " 登入"; },
    ...
    "Virtual-Card": function(d) { return "虛擬卡片"; },
    ...
    "You-have-been-removed-from-your-family-account": function(d) { return "您已從家庭帳號中移除"; },
    "You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "您需要開啟您的瀏覽器來完成登入。"; },
    ...
    "Your-account-has-switched-to-signing-in-with--identityProvider---You-ll-need-to-open-your-browser-to-complete-sign-in-": function(d) { return "你的帳號已切換為使用 " + d.identityProvider + " 登入。你需要開啟瀏覽器以完成登入。"; },
    ...
    "Your-administrator": function(d) { return "您的管理員"; },
    "one-time-password": function(d) { return "一次性密碼"; },
    "use-a-passkey": function(d) { return "使用通行密鑰"; },
    "your-browser": function(d) { return "你的瀏覽器"; },
    "your-identity-provider": function(d) { return "你的身份認證供應商"; },
    "unit.B": function(d) { return d.size + " B"; },
    "unit.KB": function(d) { return d.size + " KB"; },
    "unit.MB": function(d) { return d.size + " MB"; },
    "unit.GB": function(d) { return d.size + " GB"; },
